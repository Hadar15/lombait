    ...
    <footer className="bg-black border-t border-gray-800 relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
          ...
          >
            <motion.h3 
              className="text-white font-semibold mb-6 sm:mb-8 text-lg sm:text-xl"
              whileHover={{ x: 3 }}
              transition={{ duration: 0.2 }}
            >
              Hubungi Kami
        ...
        {/* Copyright */}
        <motion.div 
          className="mt-12 sm:mt-16 lg:mt-20 pt-8 sm:pt-12 border-t border-gray-800 text-center"
